...
describe 'DotaSteam::Requests::MatchDetailsRequest' do
  subject(:req){ DotaSteam::Requests::MatchDetailsRequest.new }

  describe '#run' do
    it 'makes http request to steam' do
      stub_request(:get, 'http://api.steampowered.com/IDOTA2Match_570/GetMatchDetails/V001/?key=EE4B46697AAE3B64E5E4334E10E7AB0F').
